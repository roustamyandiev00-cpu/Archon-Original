/** Antwoorden voor Ela wanneer er geen ingelogde chat beschikbaar is. */
export function answerNovaTourQuestion(
  ...
  if (
    ...
    return "Ela is je AI-metgezel. Ze helpt met offertes, facturen, opvolging en herinnert je aan volgende stappen — altijd ter goedkeuring.";
  }

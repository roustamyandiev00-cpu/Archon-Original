...
export const metadata: Metadata = {
  title: "AI-metgezel — Ela maakt je offertes | ArchonPro",
  description:
    "Praat, stuur je documenten, geef je instructies… Ela zet je uren achter de computer om in minuten op je gsm. Offertes & facturen met AI.",
};

const stats = [
  { value: "10 u", label: "bespaard per week met spraakherkenning" },
  { value: "+15%", label: "per offerte dankzij de suggesties van Ela" },
...
function Hero() {
  return (
    <PageHero
      ...
      subtitle="Praat, stuur je documenten, geef je instructies… Ela zet je uren achter de computer om in minuten op je gsm."
      primary={{ label: "Gratis proberen", href: "/register" }}
      secondary={{ label: "Hoe werkt het?", href: "#hoe" }}
      note="+10.000 vakmensen maken hun offertes met Ela"
      visual={
  ...
  return (
    <section id="hoe" className="relative py-24">
      <div className="mx-auto max-w-6xl px-6">
        <SectionHeading
          kicker="AI-functies"
          title="Ela automatiseert de verwerking van informatie"
          desc="Spraak, tekst, foto, document — het maakt niet uit hoe je je werken beschrijft. Ela begrijpt, analyseert en zet je instructies om in een gestructureerde offerte."
        />
        ...
        <div className="mt-14 grid gap-5 lg:grid-cols-2">
          ...
          <Card>
            ...
            <h3 className="mt-5 text-lg font-semibold text-zinc-50">
              Ela begrijpt en vat samen
            </h3>
            <p className="mt-2 text-sm leading-relaxed text-zinc-400">
              Ela transcribeert niet zomaar — ze analyseert, begrijpt het
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-medium text-emerald-400">
                  <Check size={13} /> Ela begreep: 4 gestructureerde lijnen
                </span>
    ...
    <section className="relative py-24">
      <div className="mx-auto max-w-6xl px-6">
        <SectionHeading
          ...
          title="Ela past zich aan jouw werkelijkheid en vak aan"
          desc="Onderweg, op kantoor of in de wagen — Ela is waar jij bent. 24/7 bereikbaar en ze verstaat jouw taal."
        />
        ...
        <div className="mt-14 grid gap-5 lg:grid-cols-2">
          <Card>
            ...
            <p className="mt-2 text-sm leading-relaxed text-zinc-400">
              ...
              rechtstreeks via WhatsApp — Ela is bereikbaar waar je ook bent,
          ...
          <Card>
            ...
            <h3 className="mt-5 text-lg font-semibold text-zinc-50">
              Spreek je eigen taal, Ela schrijft in het Nederlands
            </h3>
            <p className="mt-2 text-sm leading-relaxed text-zinc-400">
              Op de werf spreekt niet iedereen Nederlands. Beschrijf je werken in
              je eigen taal — Ela begrijpt en genereert een professionele
    ...
    <section className="relative py-24">
      <div className="mx-auto max-w-6xl px-6">
        <SectionHeading
          ...
          title="Ela helpt je actief bij je calculatie"
          desc="Ela voert niet alleen uit — ze stelt voor, vult aan en verrijkt. Een echte calculatiepartner, geen invoertool."
        />
        ...
        <div className="mt-14 grid items-center gap-10 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-3 text-zinc-400">
              Ela analyseert de context van je werf en stelt automatisch de
            ...
            <p className="mt-4 text-sm text-zinc-500">
              Voorbeeld: je dicteert &ldquo;tegels plaatsen badkamer&rdquo; — Ela
          ...
          <Card>
            <div className="flex items-center gap-2 text-zinc-400">
              ...
              <span className="text-sm">Suggesties van Ela</span>
            </div>
    ...
    <section className="relative py-24">
      <div className="mx-auto max-w-6xl px-6">
        <SectionHeading
          ...
          title="Ela hertekent het opstellen van offertes"
          desc="Van spraaknotitie tot getekende offerte, en dan tot factuur — Ela regisseert de hele commerciële cyclus van je werven, zonder herinvoer, zonder tijdverlies."
        />
        ...
        <div className="mt-14 grid gap-5 lg:grid-cols-2">
          <Card>
            ...
            <p className="mt-2 text-sm leading-relaxed text-zinc-400">
              Ela genereert volledige offertes met alle werklijnen, je tarieven,
          ...
          <Card>
            ...
            <p className="mt-2 text-sm leading-relaxed text-zinc-400">
              Zet een aanvaarde offerte met één klik om in een factuur. Ela neemt
    ...
    <section className="relative py-24">
      <div className="mx-auto max-w-6xl px-6">
        <SectionHeading
          ...
          desc="Ela kent de eigenheden van elk vak. Wat je activiteit ook is, ze kent je prestaties en je manier van calculeren."
        />
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-zinc-900/60 px-6 py-16 text-center sm:px-12">
          ...
          <div className="relative z-10">
            <h2 className="text-balance text-3xl font-semibold tracking-tight text-zinc-50 sm:text-4xl">
              Maak je eerste offerte met Ela in 2 minuten
            </h2>

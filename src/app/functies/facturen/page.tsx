...
export const metadata: Metadata = {
  ...
  description:
    "Offerte aanvaard? Ela maakt er in seconden een conforme factuur van. Voorschotten, saldo's, opvolging — alles geautomatiseerd. Conform e-facturatie via Peppol.",
};
...
const faqItems = [
  ...
  },
  {
    ...
    a: "Zodra je klant de offerte aanvaardt, klik je op 'Factuur maken'. Ela neemt alle lijnen, bedragen en klantgegevens over en kent automatisch het factuurnummer toe. Je hoeft niets opnieuw in te voeren.",
  },
  {
    q: "Kan ik voorschotfacturen maken?",
    a: "Ja. Je stelt je voorschot in (percentage of vast bedrag) en Ela genereert de bijhorende voorschotfactuur. De saldofactuur wordt daarna automatisch berekend. Je kunt meerdere voorschotten per werf maken.",
  },
  {
...
function Hero() {
  return (
    <PageHero
      ...
      accent="één klik"
      subtitle="Offerte aanvaard? Ela maakt er in seconden een conforme factuur van. Voorschotten, saldo's, herinneringen — alles geautomatiseerd."
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            <SectionHeading
              ...
              desc="ArchonPro is compatibel met de belangrijkste boekhoud- en beheersoftware. Behoud je bestaande tools en voeg de kracht van Ela toe — zonder iets opnieuw in te voeren."
            />
            <ul className="mt-8 space-y-3">

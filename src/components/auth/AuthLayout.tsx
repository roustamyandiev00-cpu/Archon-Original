  ...
  return (
    <>
      ...
      <main className="relative min-h-dvh overflow-x-hidden bg-zinc-950">
        ...
        <div className="relative z-10 mx-auto flex min-h-dvh max-w-[88rem] flex-col px-4 pb-4 pt-[5.5rem] sm:px-6 sm:pb-5 lg:px-8">
          <div className="grid flex-1 gap-6 lg:min-h-0 lg:grid-cols-[minmax(0,22rem)_minmax(0,1.45fr)] lg:gap-10 xl:grid-cols-[minmax(0,24rem)_minmax(0,1.55fr)]">
            <section className="flex flex-col lg:min-h-0">
              ...
              <div className="flex-1 pr-0.5 lg:min-h-0 lg:overflow-y-auto lg:overscroll-contain">
                {children}
              </div>
            </section>

...
-- Production version: 20260709174106
-- Production name: dakbedrijven_directory_and_locatie
-- Dakbedrijven directory: publieke lijst van dakwinkels, bouwbedrijven
-- en dakdekkers, los van het bouwnetwerk en los van ArchonPro-accounts.
...
-- Publieke bucket voor foto's van dakbedrijven.
